...
export const sent = async (email: string, pin: number) => 
{
    const transporte = nodemailer.createTransport({
        ...
        secure : true,
        auth : {
            user : 'movieflash.hn@gmail.com',
            pass : 'ixsyxgwcenaankhs',
        },
        tls : {
                                        ...
                                        <tr>
                                            <td class="es-adaptive esd-stripe" align="center" esd-custom-block-id="88593">
                                                <table class="es-header-body" style="background-color: #3d5ca3;" width="600" cellspacing="0" cellpadding="0" bgcolor="#3d5ca3" align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td class="esd-structure es-p20t es-p20b es-p20r es-p20l" style="background-color: #cdced0;" bgcolor="#cdced0" align="left">
                                                                        ...
                                                                        <tr>
                                                                            <td class="esd-container-frame" width="560" align="left">
                                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://i.ibb.co/TTBWVpz/Screenshot-20221120-055628.png" alt style="display: block;" width="560"></a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                        ...
                                        <tr>
                                            <td class="esd-stripe" style="background-color: #fafafa;" bgcolor="#fafafa" align="center">
                                                <table class="es-content-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td class="esd-structure es-p40t es-p20r es-p20l" style="background-color: #76f1fd;" bgcolor="#76f1fd" align="left">
                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                    <tbody>
                                                                        <tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                                                <h1 style="color: #333333; font-size: 20px;"><strong style="background-color: transparent;">OLVIDASTE TU CONTRASEÑA?</strong></h1>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p40r es-p40l" align="center">
                                                                                                <p style="color: #060505;">No te preocupes! Nos puede suceder a todos.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p35r es-p40l" align="center">
                                                                                                <p style="color: #010101;">Este es el PIN para poder cambiar su contraseña:&nbsp;</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td align="center" class="esd-block-text es-p10">
                                                                                                <p style="font-size: 18px; color: #ec2f2a;"><strong>`+ pin +`</strong></p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p25t es-p40r es-p40l" align="center">
                                                                                                <p style="color: #040404;">Si no solicitó ningun cambio, puede ignorar este correo; De lo contrario puede dar en el siguiente boton para poder ingresar su Pin y cambia la contraseña.</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border" style= "border-style: solid solid solid solid; border-color: #3d5ca3 #3d5ca3 #3d5ca3 #3d5ca3; border-width: 2px 2px 2px 2px; background: #ffffff; border-width: 2px 2px 2px 2px; display: inline-block; border-radius: 10px; width: 30%; height: 20px; display: block !important; align-items: center;">
                                                                                            <a href="http://localhost:3002/app/login/verificarPin" class="es-button" target="_blank">VERIFICAR PIN</a></span></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="esd-structure es-p20t es-p10r es-p10l" style="background-color: #76f1fd;" align="left" bgcolor="#76f1fd">
                                                        ...
                                                        <tr>
                                                            <td class="esd-structure es-p5t es-p20b es-p20r es-p20l" align="left" bgcolor="#cdced0" style="background-color: #cdced0;">
                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-text" esd-links-color="#282525" align="center">
                                                                                                <p style="font-size: 14px; color: #090909;">Contactanos: <a target="_blank" style="font-size: 14px; color: #282525;" href="tel:123456789">2</a>245-0080 | movieflash.hn@gmail.com</p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td class="esd-block-text es-p5t es-p5b" align="center">
                                                                                                <h2 style="font-size: 16px; color: #ffffff;"><strong>Copyright&nbsp;</strong>©&nbsp;Grupo 1 | Flash Movie</h2>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
